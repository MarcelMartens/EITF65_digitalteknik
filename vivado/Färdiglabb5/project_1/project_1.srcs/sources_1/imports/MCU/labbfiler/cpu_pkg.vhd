...
package cpu_pkg is
    ...
    -- Samma fast ALUOp
    constant ALU_OP_A                : std_logic_vector(2 downto 0) := "000";
    constant ALU_OP_B                : std_logic_vector(2 downto 0) := "001";
    constant ALU_OP_A_ADD_B          : std_logic_vector(2 downto 0) := "010";
    constant ALU_OP_B_SUB_A          : std_logic_vector(2 downto 0) := "011";
    constant ALU_OP_AND              : std_logic_vector(2 downto 0) := "100";
